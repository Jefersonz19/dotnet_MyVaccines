...
namespace MyVaccine.WebaApi.Migrations
{
    ...
    [Migration("20231128114047_AddingAuditFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.Allergy", b =>
                {
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.Dependent", b =>
                {
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.FamilyGroup", b =>
                {
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.Vaccine", b =>
                {
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.VaccineCategory", b =>
                {
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.VaccineRecord", b =>
                {
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FamilyGroupUser", b =>
                {
                    b.HasOne("MyVaccine.WebaApi.Models.FamilyGroup", null)
                        .WithMany()
                        .HasForeignKey("FamilyGroupsFamilyGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyVaccine.WebaApi.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.Allergy", b =>
                {
                    b.HasOne("MyVaccine.WebaApi.Models.User", "User")
                        .WithMany("Allergies")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.User", b =>
                {
                    b.HasOne("MyVaccine.WebaApi.Models.ApplicationUser", "AspNetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MyVaccine.WebaApi.Models.VaccineRecord", b =>
                {
                    b.HasOne("MyVaccine.WebaApi.Models.Dependent", "Dependent")
                    ...
                    b.HasOne("MyVaccine.WebaApi.Models.Vaccine", "Vaccine")
                        .WithMany()
            ...
            modelBuilder.Entity("VaccineVaccineCategory", b =>
                {
                    b.HasOne("MyVaccine.WebaApi.Models.VaccineCategory", null)
                        .WithMany()
                        .HasForeignKey("CategoriesVaccineCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyVaccine.WebaApi.Models.Vaccine", null)
                        .WithMany()
